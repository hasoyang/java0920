...
public class CallMain {
	...
	public static void main(String[] args) {
		...
		Future<Integer> f2 = service.submit(new ThreadEx(40023123));
		Future<Integer> f3 = service.submit(new ThreadEx(8983219));
		Future<Integer> f4 = service.submit(new ThreadEx(1232938));
